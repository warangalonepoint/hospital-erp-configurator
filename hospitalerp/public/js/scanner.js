...
// Camera barcode scanner using BarcodeDetector API (Chrome/Edge).
...
class CameraScanner {
  ...
  async open() {
    if (!("BarcodeDetector" in window)) {
      alert("Camera scan not supported. Use a USB scanner or try Chrome.");
      return;
    }
    ...
    bar.innerHTML = `
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
        ...
        <button id="scanCloseBtn"
          style="background:#1a1a24;border:1px solid #333;color:#fff;
